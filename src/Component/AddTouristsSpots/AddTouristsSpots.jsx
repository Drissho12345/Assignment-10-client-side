...
const AddTouristsSpots = () => {
    ...
    return (
        <div>
            <Helmet>
                <title>Add Tourists Spots Page</title>
            </Helmet>
            <div  className=" ">
                <form onSubmit={handleAddTouristSpot} className=" w-full pb-10 p-5 text-black bg-gray-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div  className="mb-6">
                            ...
                            <h3 className="font-bold">Seasonality:</h3>
                                <label className="input input-bordered flex bg-white items-center gap-2 mb-4">
                            ...
                            <div className="mb-10">
                                ...
                                <label className="input input-bordered flex bg-white items-center gap-2">
                                    <input type="text" className="bg-white" name="Location" placeholder="Input Location "  required/>
                    ...
                    <div className="mb-3 ">
                        ...
                        <textarea className="textarea textarea-bordered bg-white w-full" name="description" placeholder="Input Short description"></textarea>
                    </div>
                    <button className="btn bg-emerald-400 text-black w-full text-2xl">Add</button>
                </form>
            </div>
        </div>
    );
