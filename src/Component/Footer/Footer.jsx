        ...
        <div>
            <footer className="footer p-10 bg-orange-100 text-base-content">
                ...
                <nav>
                    ...
                    <a className="link link-hover">Travel policy</a>
                </nav> 
                <nav>
                    <h6 className="footer-title">Places</h6> 
                    <a className="link link-hover">Bangkok</a>
                    <a className="link link-hover">Chiang Mai</a>
                    <a className="link link-hover">Ayutthaya</a>
                    <a className="link link-hover">Phuket</a>
                </nav> 
                <nav>
